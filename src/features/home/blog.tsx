...
const posts = [
  { title: 'Arquitectura de frontend escalable con Atomic Design', date: '02 Jun 2026', category: 'Arquitectura', image: 'portfolio/blog-2.png' },
  { title: 'Optimizar React: lazy loading y code splitting en la práctica', date: '02 Jun 2026', category: 'Rendimiento', image: 'portfolio/blog-3.png' },
  { title: 'Componentes reutilizables y design systems mantenibles', date: '02 Jun 2026', category: 'React', image: 'portfolio/blog-1.png' },
];
          ...
          {posts.map((post) => (
            <Card key={post.title} className="group overflow-hidden pt-0">
              <div className="overflow-hidden bg-secondary">
                <img src={post.image} alt={`Imagen del artículo: ${post.title}`} className="h-full w-full object-contain p-2 transition-transform duration-500 group-hover:scale-105" />
              </div>
